                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                      onTap: () async {
                        String endpath = '${movieDetail.trailerId}';
                        final youtubeUrl =
                            'https://www.youtube.com/embed/${movieDetail.trailerId}';
                        // final uri = Uri.https('youtube.com','embed/'+'${movieDetail.trailerId}');
                        if (await canLaunchUrl(Uri.parse(youtubeUrl))) {
                          await launchUrl(Uri.parse(youtubeUrl),mode: LaunchMode.externalNonBrowserApplication,webViewConfiguration: WebViewConfiguration(enableJavaScript: false));
                        }
                      },
                      child: Center(
                        child: Column(
